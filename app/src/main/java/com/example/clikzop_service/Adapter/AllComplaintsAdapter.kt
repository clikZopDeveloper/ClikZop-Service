...
import com.example.clikzop_service.Model.AllComplaintsBean
import com.example.clikzop_service.R

import com.example.clikzop_service.Utills.RvStatusComplClickListner


class AllComplaintsAdapter(
    var context: Activity,
    var list: List<AllComplaintsBean.Data>,
    var rvClickListner: RvStatusComplClickListner
) : RecyclerView.Adapter<AllComplaintsAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
     ...
     /*   if (list[position].secondaryMobile.isNullOrEmpty()) {
            holder.tvMobile.text = list[position].mobile
        } else {
